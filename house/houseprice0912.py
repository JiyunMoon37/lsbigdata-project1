...
sub_df.to_csv("../data/house/sample_submission0912.csv", index=False)
...
sub_df.to_csv("C:/Users/USER/Documents/LS빅데이터스쿨/ml/data/sample_submission3.csv", index=False)
